...
# Met le fichier csv dans une variable
donnees = []
...
#Séparation des données par filière
for row in donnees:
    annee = int(row[0])
    filiere = row[1]
...
#Tracé des points(nuage de points)
...
#Évolution générale représentée par des lignes en pointillés
