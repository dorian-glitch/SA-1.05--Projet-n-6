...
donnees = []
with open('_C3_89volution_du_parc_install_C3_A9_de_production_d_27_C3_A9lectricit_C3_A9_en_France_2025-12-18_13-39.csv', newline='', encoding='utf-8') as csvfile:
...
plt.plot(dates_projection, poly_sol(dates_projection), color='orange', linestyle='dashed')
coef_ther = np.polyfit(dates, thermique_pop, 1)
poly_ther = np.poly1d(coef_ther)
plt.plot(dates_projection, poly_ther(dates_projection), color='grey', linestyle='dashed')
